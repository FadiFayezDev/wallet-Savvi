...
// ─────────────────────────────────────────────────────────────────────────────
// RowField is defined OUTSIDE AddTransactionScreen so React never unmounts it
// on re-renders, which would cause the keyboard to dismiss after each keystroke.
// ─────────────────────────────────────────────────────────────────────────────
const RowField = ({
  label,
  children,
...
export default function AddTransactionScreen() {
  ...
  // Convenience shorthand so every <RowField> call stays concise
  const rf = { theme, isArabic };
    ...
    <View className="flex-1" style={{ backgroundColor: theme.colors.background }}>
      ...
      >
        ...
        >
          ...
          {tab === "transfer" ? (
            <>
              <RowField {...rf} label={isArabic ? "المبلغ" : "Amount"}>
                <TextInput
                  value={amount}
              ...
              <RowField {...rf} label={isArabic ? "من" : "From"}>
                <ComboSelect
                  value={fromAccount}
              ...
              <RowField {...rf} label={isArabic ? "إلى" : "To"}>
                <ComboSelect
                  value={toAccount}
                  options={accountOptions}
                  placeholder={isArabic ? "اختر" : "Select"}
            ...
            <>
              <RowField {...rf} label={isArabic ? "الفئة" : "Category"}>
                <View
          ...
          <RowField {...rf} label={isArabic ? "التاريخ" : "Date"}>
            <Pressable
          ...
          {tab !== "transfer" && (
            <RowField {...rf} label={isArabic ? "الحساب" : "Account"}>
              <ComboSelect
          ...
          <RowField {...rf} label={isArabic ? "ملاحظة" : "Note"}>
            <TextInput
              value={note}
